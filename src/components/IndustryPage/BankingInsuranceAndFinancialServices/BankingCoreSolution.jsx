    ...
    <>
      <div className="content">
        <div className="container ">
          <h2 className="content__title">Core Banking, Insurance & Financial Service Solutions</h2>
            ...
            <div className="timeline">
              <div className="timeline__stepper">
                ...
                <div className="timeline__step">
                  ...
                  <p className="timeline__step-title">
                    Risk Management <br /> and Compliance
                  </p>
                </div>
                <div className="timeline__step">
                  <svg className="timeline__icon timeline__icon--default">
              ...
              <div className="timeline__slides">
                ...
                <div className="timeline__slide">
                  <h3 className="timeline__slide-title">Wealth Management</h3>
                  <div className="timeline__slide-content">
                    <p class="bullet-points">
                ...
                <div className="timeline__slide">
                  <h3 className="timeline__slide-title">Business Banking</h3>
                  <div className="timeline__slide-content">
                    <p class="bullet-points">
...
export default BankingCoreSolution;
