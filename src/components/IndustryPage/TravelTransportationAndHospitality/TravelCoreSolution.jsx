          ...
          <div className="content-border">
            <div className="timeline">
              ...
              <div className="timeline__slides">
                ...
                <div className="timeline__slide">
                  <h3 className="timeline__slide-title">Transportation Management</h3>
                  <div className="timeline__slide-content">
                    <p class="bullet-points">
                ...
                <div className="timeline__slide">
                  <h3 className="timeline__slide-title">Customer Relationship Management</h3>
                  <div className="timeline__slide-content">
                    <p class="bullet-points">
...
export default TravelCoreSolution;
