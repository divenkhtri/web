            ...
            <div className="timeline">
              <div className="timeline__stepper">
                ...
                <div className="timeline__step">
                  ...
                  <p className="timeline__step-title">Telemedicine</p>
                </div>
                <div className="timeline__step">
                  <svg className="timeline__icon timeline__icon--default">
                  ...
                  <p className="timeline__step-title">Clinical Research</p>
                </div>
                <div className="timeline__step">
                  <svg className="timeline__icon timeline__icon--default">
                    <use href="#icon-seo" />
                  ...
                  <p className="timeline__step-title">Digital Transformation</p>
                </div>
              </div>
              ...
              <div className="timeline__slides">
                ...
                <div className="timeline__slide">
                  <h3 className="timeline__slide-title">Practice Management</h3>
                  <div className="timeline__slide-content">
                    <p class="bullet-points">
                ...
                <div className="timeline__slide">
                  <h3 className="timeline__slide-title">Telemedicine</h3>
                  <div className="timeline__slide-content">
                    <p class="bullet-points">
                ...
                <div className="timeline__slide">
                  <h3 className="timeline__slide-title">Clinical Research</h3>
                  <div className="timeline__slide-content">
                    <p class="bullet-points">
...
export default PharmaCoreSolution;
