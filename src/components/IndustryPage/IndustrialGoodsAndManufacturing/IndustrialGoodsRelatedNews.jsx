...
import "../../../styles/Industry/BankingInsurance/RelatedNews.css";
const IndustrialGoodsRelatedNews = () => {
  return (
    <>
      <div className="relate-news-body">
...
export default IndustrialGoodsRelatedNews;
