            ...
            <div className="timeline">
              <div className="timeline__stepper">
                ...
                <div className="timeline__step">
                  ...
                  <p className="timeline__step-title">Digital Commerce</p>
                </div>
                <div className="timeline__step">
                  <svg className="timeline__icon timeline__icon--default">
                ...
                <div className="timeline__step">
                  ...
                  <p className="timeline__step-title">Product Management</p>
                </div>
                <div className="timeline__step">
                  <svg className="timeline__icon timeline__icon--default">
                    <use href="#icon-seo" />
              ...
              <div className="timeline__slides">
                ...
                <div className="timeline__slide">
                  <h3 className="timeline__slide-title">Product Management</h3>
                  <div className="timeline__slide-content">
                    <p class="bullet-points">
...
export default RetailCoreSolution;
